/**
 * Calculadora UFC/g para Enterobacterias.
 * Clonada de calcularUfcSau con renombre de campo de salida.
 *
 * @param {Object} params
 * @param {number} params.volumen — volumen sembrado en ml (default: 1)
 * @param {Array}  params.diluciones — [{ dil: -1, colonias: [c1, c2] }]
 * @returns {Object} { nEnterobacterias, ufcPorG, incongruenciaDetectada, observacionIncongruencia, operador, esEstimado, casoAplicado }
 */

const UMBRAL_OPTIMO_MIN = 15;
const UMBRAL_OPTIMO_MAX = 300;
const UMBRAL_MNPC = 400;
...
function calcularUfcEnt({ volumen = 1, diluciones = [] } = {}) {
