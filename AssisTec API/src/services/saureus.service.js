...
class SaureusService {
    ...
    mapEtapaPayload(body) {
        ...
        return {
            ...
            idMedioAgarBairdParker: raw.id_medio_agar_baird_parker ?? raw.idMedioAgarBairdParker,
    ...
    mapEtapa3Payload(body) {
        ...
        return {
            ...
            idMedioCaldoBhi: raw.id_medio_caldo_bhi ?? raw.idMedioCaldoBhi,
            idEstufa: raw.id_estufa ?? raw.idEstufa,
            ctrlPositivoSAureus: raw.ctrl_positivo_s_aureus ?? raw.ctrlPositivoSAureus,
    ...
    mapEtapa4Payload(body) {
        ...
        return {
            ...
            idMedioBacident: raw.id_medio_bacident ?? raw.idMedioBacident,
            idMedioAguaEsteril: raw.id_medio_agua_esteril ?? raw.idMedioAguaEsteril,
            idMicropipeta: raw.id_micropipeta ?? raw.idMicropipeta,
            idEstufa: raw.id_estufa ?? raw.idEstufa,
