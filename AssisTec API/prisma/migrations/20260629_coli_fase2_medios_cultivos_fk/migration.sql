...
ALTER TABLE "coli_fase2"
  ADD COLUMN "id_medio_caldo_lauril" INTEGER REFERENCES "medios_cultivos"("id_medio_cultivo"),
  ADD COLUMN "id_medio_tween_80"     INTEGER REFERENCES "medios_cultivos"("id_medio_cultivo");
...
ALTER TABLE "coli_fase2"
  DROP COLUMN "codigo_caldo_lauril",
  DROP COLUMN "codigo_tween_80";
