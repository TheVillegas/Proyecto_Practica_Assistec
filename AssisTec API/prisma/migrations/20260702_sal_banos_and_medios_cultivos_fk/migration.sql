...
ALTER TABLE "sal_fase1"
    ADD COLUMN "id_medio_caldo_homogeneizacion" INTEGER
...
ALTER TABLE "sal_fase1"
    DROP COLUMN "caldo_homogeneizacion";
...
ALTER TABLE "sal_fase2b"
    ADD COLUMN "id_medio_caldo" INTEGER
    REFERENCES "medios_cultivos"("id_medio_cultivo") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "sal_fase2b"
    DROP COLUMN "codigo_caldo_apt_leche";

-- 4e. New optional fields: volumen_caldo (225/450ml qualifier, not previously captured) and id_bano
ALTER TABLE "sal_fase2b"
    ADD COLUMN "volumen_caldo" VARCHAR(20),
    ADD COLUMN "id_bano" INTEGER REFERENCES "banos_termicos"("id_bano") ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE "sal_fase3b"
    DROP CONSTRAINT "sal_fase3b_id_estufa_selenito_fkey";

ALTER TABLE "sal_fase3b"
    ADD CONSTRAINT "sal_fase3b_id_estufa_selenito_fkey"
    FOREIGN KEY ("id_estufa_selenito") REFERENCES "equipos_incubacion"("id_incubacion")
    ON DELETE SET NULL ON UPDATE CASCADE;

-- 5b. New optional equipo columns (no backfill — new capacity)
ALTER TABLE "sal_fase3b"
    ADD COLUMN "id_bano_selenito"    INTEGER REFERENCES "banos_termicos"("id_bano")           ON DELETE SET NULL ON UPDATE CASCADE,
    ADD COLUMN "id_estufa_rappaport" INTEGER REFERENCES "equipos_incubacion"("id_incubacion") ON DELETE SET NULL ON UPDATE CASCADE,
    ADD COLUMN "id_bano_rappaport"   INTEGER REFERENCES "banos_termicos"("id_bano")           ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE "sal_fase4a"
    ADD COLUMN "id_medio_agar_xld" INTEGER REFERENCES "medios_cultivos"("id_medio_cultivo") ON DELETE RESTRICT ON UPDATE CASCADE,
    ADD COLUMN "id_medio_agar_ss"  INTEGER REFERENCES "medios_cultivos"("id_medio_cultivo") ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "sal_fase4a"
    DROP COLUMN "codigo_agar_xld",
    DROP COLUMN "codigo_agar_ss";

-- 6e. New optional field: id_bano_agares (no backfill — new capacity)
ALTER TABLE "sal_fase4a"
    ADD COLUMN "id_bano_agares" INTEGER REFERENCES "banos_termicos"("id_bano") ON DELETE SET NULL ON UPDATE CASCADE;
