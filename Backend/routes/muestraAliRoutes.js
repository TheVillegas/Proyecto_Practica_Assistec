...
router.post('/crearMuestra', validators.crearMuestra, muestraAliController.crearMuestraALI);
...
router.put('/observaciones', validators.actualizarObservaciones, muestraAliController.actualizarObservacionesGenerales);
